          ...
          <div class="row">
            <div class="col-12">
              <div class="btn-group" role="group" aria-label="...">
                <a href="${root}/account/profile" class="btn btn-default active"><i class="fa fa-user" aria-hidden="true"></i>Profile</a>
              ...
              <div class="innerWrapper profile">
                ...
                <div class="row">
                  <div class="col-md-4 col-lg-3 col-xl-2 col-12">
                    <div class="thumbnail">
                      <img src="${root}/assets/img/products/profile/profile-image.jpg" alt="profile-image">
                      <div class="caption">
                  ...
                  <div class="col-md-8 col-lg-9 col-xl-10 col-12">
                      <form class="form-horizontal">
                        <div class="form-group row">
                          ...
                          <div class="col-md-7">
                            <input type="text" class="form-control" id="" placeholder="Adam">
                          </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control" id="" placeholder="+884 5452 6432">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="" class="col-md-3 control-label">Email Address</label>
                          <div class="col-md-9">
                            <input type="email" class="form-control" id="" placeholder="adamsmith@bigbag.com">
                          </div>
                        </div>
                        <div class="form-group row">
