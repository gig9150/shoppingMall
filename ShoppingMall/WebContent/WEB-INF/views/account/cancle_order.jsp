          ...
          <div class="row">
            <div class="col-md-12">
              <div class="innerWrapper">
                <h3>Order # ${ordersIdx}&nbsp;&nbsp;<span> 주문취소 페이지 입니다.</span></h3>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>${goods_price}</td>
                          <td><a href="${root}/account/cancle_order_pro?ordersIdx=${ordersIdx}&goodsIdx=${goods_idx}&quantity=${orders_quantity}" class="btn btn-sm btn-secondary-outlined">주문취소</a></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
