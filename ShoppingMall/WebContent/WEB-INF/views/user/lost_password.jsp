            ...
            <div class="col-md-6 col-sm-12">
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <form action="${root}/user/lost_password_pro" method="post" role="form">
                    <p class="help-block">이메일을 입력해주세요. 임시비밀번호는 발송해드립니다.</p>
                    <div class="form-group">
                      <label class="font-weight-bold" for="">Enter Id</label>
                      <input class="form-control" name="user_id" required="required">
                    </div>
                    <div class="form-group">
                      <label class="font-weight-bold" for="">Enter Email</label>
                      <input type="email" class="form-control" name="to" required="required">
                    </div>
